			...
			<div id="user">
				...
				<form id="join-form" name="updateForm" method="post"
					...
					<label class="block-label">패스워드</label> <input name="password"
						type="password" value=""> <input name="email"
						type="hidden" value="${userVo.email}" /> <input name="no"
						type="hidden" value="${userVo.no}" /> <input name="nowpas"
						type="hidden" value="${userVo.password}" />
